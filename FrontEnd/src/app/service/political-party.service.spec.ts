...
describe('PoliticalPartyService', () => {
    ...
    beforeEach(async () => {
        mockPartyService = {
            getAllPoliticalParties: jest.fn(() => of([
                { politicalPartyId: 1, name: 'Party 1', founder: 'Founder 1', isDeleted: false },
                { politicalPartyId: 2, name: 'Party 2', founder: 'Founder 2', isDeleted: false },
            ])),
            createPoliticalParty: jest.fn(() => of({ politicalPartyId: 3, name: 'New Party', founder: 'New Founder', isDeleted: false })),
            updatePoliticalParty: jest.fn(() => of({ politicalPartyId: 1, name: 'Updated Party', founder: 'Updated Founder', isDeleted: false })),
    ...
    describe("business", () => {
        ...
        it('should delete a political party', () => {
            ...
            component.deleteParty(partyToDelete.politicalPartyId);
            fixture.detectChanges();
        ...
        it('should edit a political party', () => {
            ...
            expect({ name: 'Party 1', founder: 'Founder 1', isDeleted: false }).toEqual({ name: 'Party 1', founder: 'Founder 1', isDeleted: false });
        });
    });
});
